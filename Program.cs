...
namespace aplicacion
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // var  data=solution.FrogRiverOne(X,A);
            // int X1=1;
            // int[] A1= new int[] {1,1,1,1,1,1,1};
            // var  data1=solution.FrogRiverOne(X1,A1);
            // int X2=2;
            // int[] A2= new int[] {1,2};
            // var  data2=solution.FrogRiverOne(X2,A2);

            // int X3=1;
            // int[] A3= new int[] {1};
            // var  data3=solution.FrogRiverOne(X3,A3);
            // Console.WriteLine(data);
            // int[] A = new int [] {1};
            
            // int[] A = new int [] {1,1};
            // var dataA=solution.PermCheck(A);
            // int[] B = new int [] {4,1,3,2};
            // var dataB=solution.PermCheck(B);
            // int[] C = new int [] {4,1,3};
            // var dataC=solution.PermCheck(C);
            // int[] D = new int [] {2,4};
            // var dataD=solution.PermCheck(D);
            // int[] E = new int [] {4,0};
